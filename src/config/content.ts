...
export const content = {
  es: {
    ...
    contact: {
      ...
      saturday: "Sábado",
      sunday: "Domingo",
      emergencies: "Emergencias Dentales",
      closed: "Cerrado",
    },
    ...
    footer: {
      ...
      hours: "Estamos Aquí Para Ti",
      emergencies: "Contáctanos para agendar prioritario.",
  ...
  en: {
    ...
    contact: {
      ...
      saturday: "Saturday",
      sunday: "Sunday",
      emergencies: "Dental Emergencies",
      closed: "Closed",
    },
    ...
    footer: {
      ...
      hours: "We're Here For You",
      emergencies: "Contact us for priority scheduling.",
